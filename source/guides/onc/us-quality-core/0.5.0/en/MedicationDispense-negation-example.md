# MedicationDispense negation example - 2026 US Quality Core Implementation Guide v0.5.0

## Example MedicationDispense: MedicationDispense negation example
...
**medication**: Not Done Value Set: Ophthalmic Antihistamines (Not done value set: [Ophthalmic Antihistamines](https://vsac.nlm.nih.gov/valueset/1.3.6.1.4.1.6997.4.1.2.268.13.35211.1.13.1.999.321/expansion))
