# Number of preterm births obeservation example - 2026 US Quality Core Implementation Guide v0.5.0

## Example Observation: Number of preterm births obeservation example
