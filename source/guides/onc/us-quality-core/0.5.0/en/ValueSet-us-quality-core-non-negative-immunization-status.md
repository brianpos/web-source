# Non-Negative Immunization Status - 2026 US Quality Core Implementation Guide v0.5.0
...
```json
{
  ...
  "url" : "http://fhir.org/guides/onc/us-quality-core/ValueSet/us-quality-core-non-negative-immunization-status",
  "version" : "0.5.0",
