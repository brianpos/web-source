# MedicationRequest Practitioner Ordered Example - 2026 US Quality Core Implementation Guide v0.5.0

## Example MedicationRequest: MedicationRequest Practitioner Ordered Example
...
```json
{
  ...
  "id" : "practitioner-ordered-example",
  "meta" : {
