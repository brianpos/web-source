# US Quality Core NonPatient Observation - 2026 US Quality Core Implementation Guide v0.5.0

## Resource Profile: US Quality Core NonPatient Observation 
...
* Examples for this Profile: [Observation/example-nonpatient-hemodialysis-machine](Observation-example-nonpatient-hemodialysis-machine.md), [Observation/example-nonpatient-hospital-bed](Observation-example-nonpatient-hospital-bed.md) and [Observation/example-nonpatient-mechanical-ventilator](Observation-example-nonpatient-mechanical-ventilator.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.onc.us-quality-core|current/StructureDefinition/StructureDefinition-us-quality-core-nonpatient-observation.json)
...
Other representations of profile: [CSV](../StructureDefinition-us-quality-core-nonpatient-observation.csv), [Excel](../StructureDefinition-us-quality-core-nonpatient-observation.xlsx), [Schematron](../StructureDefinition-us-quality-core-nonpatient-observation.sch) 
...
```json
{
  ...
  "id" : "us-quality-core-nonpatient-observation",
  "url" : "http://fhir.org/guides/onc/us-quality-core/StructureDefinition/us-quality-core-nonpatient-observation",
  "version" : "0.5.0",
  "name" : "USQualityCoreNonPatientObservation",
  "title" : "US Quality Core NonPatient Observation",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-05",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "The device/location/implantable device the observation is about",
      "definition" : "The device/location/implantable device this observation is about and into whose record the observation is placed. If the actual focus of the observation is different from the subject (or a sample of, part, or region of the subject), the `focus` element or the `code` itself specifies the actual focus of the observation.",
      "comment" : "One would expect this element to be a cardinality of 1..1.",
      "min" : 1,
      "max" : "1",
      "base" : {
        "path" : "Observation.subject",
    ...
    },
    {
      ...
      "short" : "US Quality Core Profiles or other resource the observation is made from",
      "definition" : "Observations, DocumentReference, QuestionnaireResponse or other resource from which this observation value is derived.",
